...
public class QuestionController {
  ...
  @GetMapping("/random")
  public List<QuestionVo> getRandomQuestion(
      @Parameter(description = "需要获取的问题数量") @RequestParam(defaultValue = "10") int num,
      @AuthenticationPrincipal UserVo user) {
    return questionService.getRandomQuestion(num, user);
  }
  ...
  public Page<QuestionVo> searchQuestion(
      ...
      @AuthenticationPrincipal UserVo user) {
    return questionService.searchQuestion(keyword, pageNum, pageSize, user);
  }
}
